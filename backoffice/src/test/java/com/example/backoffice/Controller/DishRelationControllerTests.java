...
class DishRelationControllerTests {
        @Autowired
        ...
        void shouldGetAll() throws Exception {
                ...
                mockMvc.perform(get("/dishRelation")
                                ...
                                .andExpect(jsonPath("$[0].dishMetadata.description")
                                                .value(dishMetadata.getDescription()))
                                ...
                                .andExpect(jsonPath("$[0].ingredient.category.id")
                                                .value(ingredient.getCategory().getId()))
                                .andExpect(jsonPath("$[0].ingredient.category.name")
                                                .value(ingredient.getCategory().getName()))
        ...
        void shouldCreate() throws Exception {
                ...
                mockMvc.perform(post("/dishRelation")
                                ...
                                .andExpect(jsonPath("$.ingredient.category.name")
                                                .value(ingredient.getCategory().getName()))
                ...
                assertThat(captured.getIngredientId()).isEqualTo(payload.getIngredientId());
        ...
        @Test
        void shouldReturnBadRequestWhenIngredientAndLabelAreMissing() throws Exception {
                DishRelationDTO payload = new DishRelationDTO();
                payload.setDishMetadataId(dishMetadata.getId());

                when(dishRelationService.create(any(DishRelationDTO.class)))
                                .thenThrow(new DishRelationDataNotValidException());
                ...
                mockMvc.perform(post("/dishRelation")
                                ...
                                .andExpect(status().isBadRequest())
                                .andExpect(jsonPath("$.success").value(false))
                                .andExpect(jsonPath("$.message").value("IngredientId or labelId is required"));

                verify(dishRelationService).create(any(DishRelationDTO.class));
        }
