...
class DishMetadataControllerTests {
        @Autowired
        ...
        @Test
        void shouldCreateWithNegativePrice() throws Exception {
                DishMetadataDTO payload = new DishMetadataDTO();
                payload.setName("canard laqué");
                payload.setDescription("style pékin");
        ...
        @Test
        void shouldReturnBadRequestWhenPriceIsNotANumber() throws Exception {
                String payload = """
                                {
                                  "name": "canard laqué",
                                  "description": "style pékin",
                                  "price": "not-a-number"
                                }
                                """;
                ...
                mockMvc.perform(post("/dishMetadata")
                                ...
                                .andExpect(status().isBadRequest())
                                .andExpect(jsonPath("$.success").value(false))
                                .andExpect(jsonPath("$.message").value("Price should be a number"));
